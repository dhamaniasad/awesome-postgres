...
* [Azure Database for PostgreSQL](https://azure.microsoft.com/en-us/products/postgresql/) - Azure Database for PostgreSQL provides fully managed, enterprise-ready community PostgreSQL database as a service. It provides builtin HA, elastic scaling and native integration with Azure ecosystem.
* [Baidu AI Cloud RDS for PostgreSQL](https://cloud.baidu.com/en/product/postgresql.html) - RDS for PostgreSQL offers high-performance and -reliability relational database services. It supports standard database protocols, whose abundant aggregation analysis function can deliver complicated SQL processing ability and makes possible the PostGIS geographic information processing. Meanwhile, it achieves several features, such as monitoring, fail-over, data backup and recovery, and instance management. (cn, apac)
* [Civo Managed Databases](https://www.civo.com/public-cloud/databases) - A powerful and scalable managed database service at an affordable price.
* [ClickHouse Managed Postgres](https://clickhouse.com/docs/cloud/managed-postgres) - Enterprise-grade managed Postgres service built for performance and scale. Backed by NVMe storage that is physically collocated with compute, it delivers up to 10x faster performance for workloads that are disk-bound compared to alternatives using network-attached storage like EBS.
* [Cloud.ru Evolution Managed PostgreSQL](https://cloud.ru/products/evolution-managed-postgresql) - Managed PostgreSQL service on Cloud.ru Evolution for running PostgreSQL clusters. (ru)
...
* [MWS Managed PostgreSQL](https://mws.ru/cloud-platform/managed-postgresql/) - Managed PostgreSQL service with automated backups and failover. (ru)
...
* [Neon](https://neon.com) - Fully managed serverless PostgreSQL. Neon separates storage and compute to offer modern developer features such as serverless, branching, bottomless storage, and more.
...
* [OVHcloud Cloud Databases](https://www.ovhcloud.com/en/public-cloud/postgresql/) - Highly available, scalable, and secured PostgreSQL. Daily backups with point-in-time recovery, no lock-in, free incoming and outgoing traffic. (eu-focused)
...
* [Railway PostgreSQL](https://docs.railway.com/databases/postgresql) - The Railway PostgreSQL database template allows you to provision and connect to a PostgreSQL database with zero configuration.
* [Render Managed PostgreSQL](https://render.com/docs/postgresql) - Secure, reliable, and completely hands-off managed PostgreSQL. Encryption at rest, automated backups, and expandable SSD storage included in all plans. Plans start at $7 per month for 256MB RAM and 1GB storage (free for first 90 days).
* [ScaleGrid PostgreSQL DBaaS](https://scalegrid.io/postgresql/) - Fully managed PostgreSQL hosting with high availability, dedicated servers, and superuser control on the #1 multi-cloud Amazon RDS alternative.
* [Scaleway Managed Database](https://www.scaleway.com/en/managed-postgresql-mysql/) - Fully managed PostgreSQL databases with HA, scaling, and automated backups, hosted in the EU. Starting at €10 per month. (eu-focused)
* [Scalingo for PostgreSQL](https://scalingo.com/databases/postgresql) - Fully managed, highly-available PostgreSQL for application platforms. (eu-focused)
* [Selectel Cloud for PostgreSQL](https://selectel.ru/services/cloud/managed-databases/postgresql/) - Managed PostgreSQL service by Selectel with backups, monitoring, and scaling. (ru, cis)
* [Stackhero for PostgreSQL](https://www.stackhero.io/en-US/services/PostgreSQL/benefits) - Managed PostgreSQL optimized for performance and security, deployable in minutes. (eu-focused)
...
* [Thalassa Cloud DBaaS](https://thalassa.cloud/products/databases/postgresql/) - Fully managed PostgreSQL database, multi-AZ, automated backups, hosted in the Netherlands. (eu-focused)
* [Tiger Data Postgres](https://www.tigerdata.com/) - PostgreSQL cloud platform for high-load, real-time, and distributed workloads.
* [Timeweb Cloud Managed Service for PostgreSQL](https://timeweb.cloud/services/postgresql) - Managed PostgreSQL service from Timeweb Cloud. (ru)
...
* [Vela](https://vela.simplyblock.io/) - Postgres-based backend-as-a-service built for modern AI apps. Offers instant database branches and clones, production-like test environments, and serverless scaling.
...
* [VK Cloud PostgreSQL as a Service](https://cloud.vk.com/databases/postgresql/) - Managed PostgreSQL offering within VK Cloud's database services. (ru)
...
* [Yandex Cloud Managed Service for PostgreSQL](https://yandex.cloud/en/services/managed-postgresql) - Managed PostgreSQL clusters in Yandex Cloud infrastructure. (ru, cis)
