...
* [wal-g](https://github.com/wal-g/wal-g) - The successor of WAL-E rewritten in Go. Currently supports S3, GCP, Azure, Swift and file system storages. Supports block-level incremental backups.
