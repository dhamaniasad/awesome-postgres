...
* [Runsite PostgreSQL](https://runsite.app/services/postgresql) - Managed PostgreSQL 14–17 hosted in the EU (Frankfurt) with daily encrypted backups and point-in-time recovery. Free tier provides 256 MB RAM and 1 GB storage for 30 days; paid plans from €5 per month. (Commercial Software)
