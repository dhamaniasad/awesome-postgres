...
* [Baidu AI Cloud RDS for PostgreSQL](https://cloud.baidu.com/en/product/postgresql.html) - RDS for PostgreSQL offers high-performance and -reliability relational database services. It supports standard database protocols, whose abundant aggregation analysis function can deliver complicated SQL processing ability and makes possible the PostGIS geographic information processing. Meanwhile, it achieves several features, such as monitoring, fail-over, data backup and recovery, and instance management.
