...
- [pg_barcode](https://github.com/btouchard/pg_barcode/) - PostgreSQL SVG QRcode & Datamatrix generator.
...
- [pg_stat_monitor](https://github.com/percona/pg_stat_monitor) - Query Performance Monitoring tool for PostgreSQL.
- [pg_squeeze](https://github.com/cybertec-postgresql/pg_squeeze) - An extension for automatic bloat cleanup with minimal locking.
...
- [catqueue](https://github.com/karanrajsurya/CatQueue_npm_package) - A Redis-free PostgreSQL-native job queue for Node.js and TypeScript.
