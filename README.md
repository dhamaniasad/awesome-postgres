...
* [Gallium Data](https://www.galliumdata.com) - Database gateway that can change the traffic between client and server without modifying either (commercial software but free to use).
