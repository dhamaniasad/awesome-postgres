...
> A curated list of awesome [PostgreSQL](https://www.postgresql.or/) software, libraries, tools and resources, inspired by [awesome-mysql](http://shlomi-noach.github.io/awesome-mysql/)
...
* [Rivestack](https://rivestack.io) - Managed PostgreSQL with pgvector for AI workloads. HNSW indexing on NVMe storage, built-in SQL editor that converts search queries to embeddings, daily snapshots, point-in-time recovery, and HA. Free tier available.
