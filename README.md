...
* [json2sql](https://github.com/Coding-Dev-Tools/json2sql) - Convert JSON data to SQL INSERT/UPDATE statements for PostgreSQL and other databases, with schema inference and validation.
