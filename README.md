...
* [Rivestack](https://rivestack.io) - Managed PostgreSQL with pgvector for AI workloads. HNSW indexing on NVMe storage, built-in SQL editor that converts search queries to embeddings automatically, sub-4ms latency, and HA. Free tier with 2GB storage.
