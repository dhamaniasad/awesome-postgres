...
* [nancy](https://gitlab.com/postgres-ai/nancy) - The Nancy CLI is a unified way to manage automated database experiments either in clouds or on-premise ([archived](https://gitlab.com/postgres-ai/nancy/-/issues/228))
